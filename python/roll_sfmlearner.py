...
from numpy import load, linspace, deg2rad, rad2deg, mean, zeros, std, asarray, NaN
from skimage.transform import hough_line, hough_line_peaks, resize

cfg = {
    'disparities_path': '/media/tom/seagate-8tb-ext4/data/kitti_derived/roll/output_sfmlearner/disparities_.npy',
    'test_disp': (0.37, 0.375),
    ...
    'image_shape': (244, 807),
    'output_path': '/media/tom/seagate-8tb-ext4/data/kitti_derived/roll/output_sfmlearner/roll.csv'
}
