...
cfg = {
    ...
    'disparities_path': '/media/tom/seagate-8tb-ext4/data/kitti_derived/pitch/output_sfmlearner/disparities_.npy',
    'image_shape': (300, 993),
    'output_path': '/media/tom/seagate-8tb-ext4/data/kitti_derived/pitch/output_sfmlearner/pitch.csv'
}
