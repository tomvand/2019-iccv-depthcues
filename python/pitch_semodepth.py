...
cfg = {
    'filenames_path': '/media/tom/seagate-8tb-ext4/data/kitti_derived/pitch/filenames_semodepth.txt',
    'filename_re': '.*/(?P<filename>[0-9]*_[0-9]*)_(?P<y>[-0-9]*).png',
    'image_shape': (300, 993),
    'output_path': '/media/tom/seagate-8tb-ext4/data/kitti_derived/pitch/output_semodepth/pitch.csv'
}
