...
cfg = {
    'disparities_path': '/media/tom/seagate-8tb-ext4/data/kitti_derived/roll/output_LKVOLearner/output.npy',
    'test_disp': (4.1, 4.2),
    ...
    'image_shape': (244, 807),
    'output_path': '/media/tom/seagate-8tb-ext4/data/kitti_derived/roll/output_LKVOLearner/roll.csv'
}
